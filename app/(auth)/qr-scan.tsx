...
import { useClass, useSchool, useThemedStyles } from '@/hooks'
...
function handleError(setError: (message: string) => void, message: string, showErrorModal: (visible: boolean) => void) {
  setError(message)
  showErrorModal(true)
}
