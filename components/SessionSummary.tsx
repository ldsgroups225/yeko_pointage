import type { AttendanceSession, ParticipationSession } from '@/types'
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text>
          Date:
          {formatDate(new Date(attendanceSession.date))}
        </Text>
        <Text>
          Time:
          {' '}
          {formatTime(new Date(attendanceSession.startTime))}
          {' '}
          -
          {' '}
      ...
      <View style={styles.section}>
        ...
        <Text>
          ...
          {' '}
          {participationSession.participations.length}
        </Text>
        {participationSession.participations.map((p, index) => (
          <Text key={index}>
            ...
            {' '}
            -
            {formatTime(new Date(p.timestamp))}
          </Text>
        ))}
      </View>
    </ScrollView>
